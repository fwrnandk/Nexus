        ...
        <div class="form">
            <?php
                ...
                if(!empty($dados['cadEnd'])) {
                    ...
                    if ($stmt->rowCount() > 0) {
                        echo "<p style='color:green'>Endereço atualizado com sucesso! <a href='principal.php'>Clique para voltar para pagina home.</a></p>";
                    } else {
            ...
            <div class="login-button">
                <a href=""><input type="submit" name="cadEnd" value="PROXIMO"></a>
                </form>
            </div>
        </div>
    </div>
